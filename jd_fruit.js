...
[task_local]
#jd免费水果
1 6-18/6 * * * jd_fruit_task.js, tag=东东农场日常任务, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdnc.png, enabled=true
=========================Loon=============================
[Script]
    ...
    if (!$.farmTask.gotBrowseTaskAdInit.f) {
        ...
        for (let advert of adverts) { //开始浏览广告
            ...
            if ($.browseResult.code === '0') {
             ...
             await browseAdTaskForFarm(advert.advertId, 1);
             console.log(`强制广告奖励结果:  ${JSON.stringify($.browseRwardResult)}`)
        }
        if (browseFail > 0) {
